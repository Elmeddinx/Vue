                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mobile-logo text-center">
                                <a href="index-2.html"><img alt="" class="img-fluid" src="../../assets/images/header-logo.png"></a>
                            </div>
                        </div>
                        <!-- Logo Col End -->
                    </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-9 pl-0">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index-2.html"><img alt="" class="img-fluid" src="../../assets/images/header-logo.png"></a>
                            <!-- Logo End -->
